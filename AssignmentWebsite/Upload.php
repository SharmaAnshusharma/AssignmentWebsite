...
<div class="container col-sm-6 ">
	...
	<form method="post" enctype="multipart/form-data">
		...
		<br><br>
		<p>Note: You Can Upload txt, pdf and docx files.</p>
		  <a href="#" title="Payment Option" data-toggle="popover" data-placement="right" data-content="Google Pay, Phone Pay and Paytm- 7007976332">Payment Option</a>
		<script>
...
if(isset($_POST['submit']))
{
	...
	$ins = mysqli_query($con,"INSERT INTO `upload`(`Name`, `Email`, `Mobile`, `File`) VALUES ('$name','$email','$contact','$store')");
	if($ins == true)
	{
